...
public class AdventureTest {
    ...
    public void attackAdventures() {
        ...
        adventure.attackAdventures("sword", attacks);
        adventure.attackAdventures("axe", attacks);
        adventure.attackAdventures("blade", attacks);

        ArrayList<Adventure> attacks2 = new ArrayList<>();
        attacks2.add(adventure);
        attacks2.add(adventure3);
        adventure2.attackAdventures("sword2", attacks2);
    ...
    public void attackedByAdventure() {
        ...
        adventure2.attackedByAdventure(adventure, (Equipment) adventure.getPackages().get(123));
        adventure2.attackedByAdventure(adventure, (Equipment) adventure.getPackages().get(124));
        adventure2.attackedByAdventure(adventure, (Equipment) adventure.getPackages().get(125));
    }
